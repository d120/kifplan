...
class Kiffel(models.Model):
    ...
    kommentar_public = models.TextField(blank=True)
    kommentar_orga = models.TextField(blank=True)
    anreise_geplant = models.DateTimeField()
    abreise_geplant = models.DateTimeField()
    ernaehrungsgewohnheit = models.CharField(max_length=100, blank=True)
    lebensmittelunvertraeglichkeiten = models.CharField(max_length=400, blank=True)
    ...
    engel_handle = models.CharField(max_length=100, blank=True)
